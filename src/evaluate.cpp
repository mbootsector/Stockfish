...
#define S(mg, eg) make_score(mg, eg)
  ...
  const Score MobilityBonus[][32] = {
    { S(-56,-57), S(-42,-40), S( -6,-21), S( -1, -7), S(  4,  3), S( 10,  9), // Knights
      S( 16, 19), S( 21, 21), S( 27, 21) },
    { S(-36,-44), S(-15,-17), S( 12, -2), S( 19,  9), S( 28, 18), S( 38, 31), // Bishops
      S( 41, 40), S( 47, 42), S( 47, 48), S( 51, 54), S( 60, 58), S( 60, 64),
      S( 68, 66), S( 73, 72) },
    { S(-43,-57), S(-20,-13), S(-11, 21), S( -7, 41), S( -3, 51), S( -1, 61), // Rooks
      S(  6, 84), S( 12, 88), S( 22, 99), S( 21,106), S( 24,116), S( 28,123),
      S( 34,124), S( 36,126), S( 43,128) },
    { S(-29,-27), S(-15,-11), S(  2,  6), S(  2, 13), S( 10, 25), S( 16, 40), // Queens
      S( 21, 45), S( 30, 54), S( 32, 59), S( 36, 69), S( 42, 70), S( 45, 78),
      S( 45, 84), S( 49, 90), S( 50, 92), S( 52, 94), S( 53, 99), S( 54,102),
      S( 59,105), S( 66,107), S( 66,111), S( 74,124), S( 76,127), S( 76,131),
      S( 79,138), S( 81,143), S( 84,154), S( 87,159) }
  };
