...
enum Value : int {
  ...
  KnightValueMg = 817,   KnightValueEg = 846+50,
  BishopValueMg = 836,   BishopValueEg = 857+50,
  RookValueMg   = 1270,  RookValueEg   = 1281+75,
  QueenValueMg  = 2521,  QueenValueEg  = 2558+150,
